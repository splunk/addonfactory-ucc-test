...
def create_identifier(*, id_type:IdentifierType=IdentifierType.ALPHANUM, in_uppercase:bool = False) -> str:
        ...
        if id_type == IdentifierType.HEX:
            ...
            return hex_identifier.upper() if in_uppercase else hex_identifier.lower()
