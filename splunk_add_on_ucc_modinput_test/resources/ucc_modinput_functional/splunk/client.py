from splunk_add_on_ucc_modinput_test.functional.decorators import register_splunk_class
...
class SplunkClient(SplunkClientBase):
    ...
    def search(self, searchquery):
        return splunk_instance.search(service=self.splunk, searchquery=searchquery)
    ...
    def get_ta_log_level(self):
        ...
        try:
            ...
            api_response = self.ta_api.splunk_ta_example_settings_logging_get(output_mode)
            pprint(api_response)
    ...
    def set_ta_log_level(self, loglevel: str = defaults.TA_LOG_LEVEL_FOR_TESTS):
        pprint(f"Configuring TA log level to {loglevel}")
        try:
            api_response = self.ta_api.splunk_ta_example_settings_logging_post(output_mode, loglevel=loglevel)
            pprint(api_response)
        except ApiException as e:
    ...
    def create_account(
        ...
        *,
        ...
        try:
            api_response = self.ta_api.splunk_ta_example_account_post(output_mode, name=name, api_key=api_key)
            pprint(api_response)
        except ApiException as e:
    ...
    def get_account(
        ...
        *,
        ...
        try:
            api_response = self.ta_api.splunk_ta_example_account_name_get(name, output_mode)
            pprint(api_response)
        except ApiException as e:
    ...
    def create_input(
        ...
        *,
        ...
        try:
            ...
            api_response = self.ta_api.splunk_ta_example_example_post(output_mode, name=name, interval=interval, index=index, account=account)
            pprint(api_response)
        except ApiException as e:
    ...
    def disable_input(self, *, name: str):
        try:
            api_response = self.ta_api.splunk_ta_example_example_name_post(output_mode, name, disabled=True)
            pprint(api_response)
        except ApiException as e:
